#' Plot Method for a Finite Binomial Mixture Regression Model of class "FBMRM"
#'
...
#'
#' @param x An object of class "FBMRM", the result of calling FMRM() or
