...
#'
#' Computes sparse group lasso (SGL) penalty for variable selection for finite
#' Gaussian mixture regression models within iterations of the MM algorithm.
#' This function is used during model estimation.
#'
...
#' number of mixture components in the finite Gaussian mixture regression model.
#'
