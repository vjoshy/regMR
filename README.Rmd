...
gaussian_df <- data.frame(
  ...
  G = rep(3:7, times = 3),
  Replications = 10,
  Elapsed = c(103.254, 125.252, 230.807, 359.222, 715.479,
...
poisson_df <- data.frame(
  ...
  G = rep(3:7, times = 3),
  Replications = 10,
  Elapsed = c(289.525, 831.046, 836.103, 1622.873, 2265.934,
...
binomial_df <- data.frame(
  ...
  G = rep(3:7, times = 3),
  Replications = 10,
  Elapsed = c(107.470, 380.681, 873.549, 1646.376, 2815.387,
