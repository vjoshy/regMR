...
These simulations were carried out in R (version 4.5.0) with RStudio (version 2026.06.0+242). For benchmarking, the `rbenchmark` package was used, found here: <https://cran.r-project.org/web/packages/rbenchmark/index.html>. They were ran on a MacBook Air (2022) with an M2 chip, 8 cores (4 performance and 4 efficiency), and 8 GB of memory. The code used to generate the data to fit each family of finite mixture regression model to is included below.
